...
<template>
  <div class="version-reward-bg">
    ...
    <!-- <div class="version-reward-bg-bottom-bar">
      <div class="version-reward-bg-bottom-bar-1"></div>
      <div class="version-reward-bg-bottom-bar-2"></div>
      <div class="version-reward-bg-bottom-bar-3"></div>
      <div class="version-reward-bg-bottom-bar-4"></div>
      <div class="version-reward-bg-bottom-bar-5"></div>
    </div> -->
  </div>
</template>
