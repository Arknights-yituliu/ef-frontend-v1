<template>
  <article
    ...
    @click="emit('toggle-sold-out')"
    @keydown.enter.prevent="emit('toggle-sold-out')"
    @keydown.space.prevent="emit('toggle-sold-out')"
  >
    ...
    <div class="shop-item-card-body">
      <div class="shop-item-card-score-row">
        <div
          ...
          :style="getCostPerformanceBadgeStyle(item.costPerformance, shopId)"
        >
...
const { item, shopId, titleIconUrl } = toRefs(props);
</script>
